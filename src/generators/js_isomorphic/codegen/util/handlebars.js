...
handlebars.registerHelper('objectName', (str) => capitalizeFirstLetter(toCamelCase(slug(str))));

handlebars.registerHelper('className', (str) => capitalizeFirstLetter(toCamelCase(slug(str))));
...
handlebars.registerHelper('operationName', (operation, resourcePath) => getFunctionName(operation, resourcePath));
