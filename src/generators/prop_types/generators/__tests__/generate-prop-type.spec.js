...
import generatePropType from '../generate-prop-type'; // eslint-disable-line import/no-named-as-default
...
describe('generatePropType', () => {
  ...
  it('should return prop type code for an enum entity', () => {
    const entity = {
    ...
    const propTypeCode = generatePropType(entity, service);

    expect(propTypeCode.length).toBeGreaterThan(0);
  });

  it('should return prop type code for a model entity', () => {
    const entity = {
  ...
  it('should return prop type code for a union entity', () => {
    const entity = {
  ...
  it('should throw an error with an unsupported entity type', () => {
    ...
    expect(() => generatePropType(entity, service)).toThrow();
  });
});
