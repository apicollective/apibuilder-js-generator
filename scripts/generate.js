#!/usr/bin/env node
/* eslint-disable max-len, no-param-reassign, no-cond-assign */
 ...
 *
 * output is written to ./user-generated
 */
...
program
  ...
  .option('--output [output]', 'path to directory where files will be generated', path.resolve(process.cwd(), './user-generated'))
