...
const toCustomScalarType = require('../../../../../src/generators/node_graphql/utilities/toCustomScalarType');
...
describe('toGraphQLScalarType', () => {
  it('should convert from apibuilder types to built-in GraphQL types', () => {
    ...
    expect(toGraphQLScalarType(typeFromAst(astFromTypeName('date-iso8601'), service))).toEqual(undefined);
    expect(toGraphQLScalarType(typeFromAst(astFromTypeName('date-time-iso8601'), service))).toEqual(undefined);
